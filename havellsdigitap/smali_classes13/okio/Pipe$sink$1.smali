...
.method public close()V
    ...
    .line 541
    .line 542
    invoke-virtual {v2, v6, v7, v8}, Lokio/Timeout;->timeout(JLjava/util/concurrent/TimeUnit;)Lokio/Timeout;
    ...
    .line 578
    .line 579
    invoke-virtual {v2, v4, v5, v8}, Lokio/Timeout;->timeout(JLjava/util/concurrent/TimeUnit;)Lokio/Timeout;
    ...
    .line 770
    .line 771
    invoke-virtual {v2, v4, v5, v6}, Lokio/Timeout;->timeout(JLjava/util/concurrent/TimeUnit;)Lokio/Timeout;
...
.method public flush()V
    ...
    :cond_3
    :try_start_1
    invoke-interface {v3}, Lokio/Sink;->flush()V
    :try_end_1
...
.method public write(Lokio/Buffer;J)V
    ...
    .line 1
    iget-object v2, v1, Lokio/Pipe$sink$1;->this$0:Lokio/Pipe;

    invoke-virtual {v2}, Lokio/Pipe;->getBuffer$okio()Lokio/Buffer;

    move-result-object v2

    iget-object v3, v1, Lokio/Pipe$sink$1;->this$0:Lokio/Pipe;
    ...
    .line 8
    iget-object v7, v1, Lokio/Pipe$sink$1;->timeout:Lokio/Timeout;

    invoke-virtual {v3}, Lokio/Pipe;->getBuffer$okio()Lokio/Buffer;

    move-result-object v8

    invoke-virtual {v7, v8}, Lokio/Timeout;->waitUntilNotified(Ljava/lang/Object;)V
    ...
    invoke-virtual {v9, v0, v7, v8}, Lokio/Buffer;->write(Lokio/Buffer;J)V
    ...
    .line 16
    invoke-interface {v9}, Lokio/Sink;->timeout()Lokio/Timeout;
    ...
    invoke-virtual {v3, v10, v11, v12}, Lokio/Timeout;->timeout(JLjava/util/concurrent/TimeUnit;)Lokio/Timeout;
    ...
    :cond_5
    :try_start_1
    invoke-interface {v9, v0, v5, v6}, Lokio/Sink;->write(Lokio/Buffer;J)V
    :try_end_1
    .catchall {:try_start_1 .. :try_end_1} :catchall_0

    .line 24
    invoke-virtual {v3, v7, v8, v12}, Lokio/Timeout;->timeout(JLjava/util/concurrent/TimeUnit;)Lokio/Timeout;
    ...
    .line 26
    invoke-virtual {v3, v10, v11}, Lokio/Timeout;->deadlineNanoTime(J)Lokio/Timeout;
    ...
    invoke-virtual {v3, v7, v8, v0}, Lokio/Timeout;->timeout(JLjava/util/concurrent/TimeUnit;)Lokio/Timeout;
