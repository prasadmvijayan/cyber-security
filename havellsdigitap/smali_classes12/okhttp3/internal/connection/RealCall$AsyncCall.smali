...
.method public compareTo(Ljava/lang/Object;)I
    ...
    check-cast p1, Lokhttp3/internal/connection/RealCall$AsyncCall;

    invoke-virtual {p0, p1}, Lokhttp3/internal/connection/RealCall$AsyncCall;->compareTo(Lokhttp3/internal/connection/RealCall$AsyncCall;)I
...
.method public compareTo(Lokhttp3/internal/connection/RealCall$AsyncCall;)I
    .locals 3
    ...
    invoke-virtual {v1}, Lokhttp3/internal/connection/RealCall;->getOriginalRequest()Lokhttp3/Request;

    move-result-object v1

    const-class v2, Lokhttp3/priority/Priority;

    invoke-virtual {v1, v2}, Lokhttp3/Request;->tag(Ljava/lang/Class;)Ljava/lang/Object;

    move-result-object v1

    check-cast v1, Lokhttp3/priority/Priority;

    if-nez v1, :cond_0

    sget-object v1, Lokhttp3/priority/Priority$Companion;->DEFAULT:Lokhttp3/priority/Priority;

    :cond_0
    invoke-virtual {p1}, Lokhttp3/internal/connection/RealCall$AsyncCall;->getRequest()Lokhttp3/Request;
    ...
    check-cast p1, Lokhttp3/priority/Priority;

    if-nez p1, :cond_1

    sget-object p1, Lokhttp3/priority/Priority$Companion;->DEFAULT:Lokhttp3/priority/Priority;

    :cond_1
    invoke-virtual {v1}, Lokhttp3/priority/Priority;->getValue()I

    move-result v1

    invoke-virtual {p1}, Lokhttp3/priority/Priority;->getValue()I
...
.method public final getCallsPerHost()Ljava/util/concurrent/atomic/AtomicInteger;
    ...
    .line 226
    .line 227
    iget-object v1, p0, Lokhttp3/internal/connection/RealCall$AsyncCall;->callsPerHost:Ljava/util/concurrent/atomic/AtomicInteger;
...
.method public run()V
    ...
    .line 40
    .line 41
    invoke-interface {v6, v1, v4}, Lokhttp3/Callback;->onResponse(Lokhttp3/Call;Lokhttp3/Response;)V
    :try_end_2
    ...
    .line 84
    .line 85
    invoke-interface {v6, v1, v5}, Lokhttp3/Callback;->onFailure(Lokhttp3/Call;Ljava/io/IOException;)V
