...
.method public static amb(Ljava/lang/Iterable;)Lio/reactivex/Completable;
    ...
    .line 58
    invoke-direct {v1, v2, p0}, Lio/reactivex/internal/operators/completable/CompletableAmb;-><init>([Lio/reactivex/CompletableSource;Ljava/lang/Iterable;)V
...
.method public static concat(Ljava/lang/Iterable;)Lio/reactivex/Completable;
    ...
    .line 2
    new-instance v1, Lio/reactivex/internal/operators/completable/CompletableConcatIterable;

    invoke-direct {v1, p0}, Lio/reactivex/internal/operators/completable/CompletableConcatIterable;-><init>(Ljava/lang/Iterable;)V
...
.method public static defer(Ljava/util/concurrent/Callable;)Lio/reactivex/Completable;
    ...
    .line 226
    .line 227
    const-string v1, "completableSupplier"
    ...
    .line 231
    .line 232
    new-instance v1, Lio/reactivex/internal/operators/completable/CompletableDefer;

    .line 233
    .line 234
    invoke-direct {v1, p0}, Lio/reactivex/internal/operators/completable/CompletableDefer;-><init>(Ljava/util/concurrent/Callable;)V
...
.method public static error(Ljava/util/concurrent/Callable;)Lio/reactivex/Completable;
    ...
    .line 2
    new-instance v1, Lio/reactivex/internal/operators/completable/CompletableErrorSupplier;

    invoke-direct {v1, p0}, Lio/reactivex/internal/operators/completable/CompletableErrorSupplier;-><init>(Ljava/util/concurrent/Callable;)V
...
.method public static fromAction(Lio/reactivex/functions/Action;)Lio/reactivex/Completable;
    ...
    .line 59
    .line 60
    invoke-direct {v1, p0}, Lio/reactivex/internal/operators/completable/CompletableFromAction;-><init>(Lio/reactivex/functions/Action;)V
...
.method public static fromObservable(Lio/reactivex/ObservableSource;)Lio/reactivex/Completable;
    ...
    .line 72
    .line 73
    new-instance v1, Lio/reactivex/internal/operators/completable/CompletableFromObservable;

    .line 74
    .line 75
    invoke-direct {v1, p0}, Lio/reactivex/internal/operators/completable/CompletableFromObservable;-><init>(Lio/reactivex/ObservableSource;)V
...
.method public static fromRunnable(Ljava/lang/Runnable;)Lio/reactivex/Completable;
    ...
    .line 159
    .line 160
    new-instance v1, Lio/reactivex/internal/operators/completable/CompletableFromRunnable;

    .line 161
    .line 162
    invoke-direct {v1, p0}, Lio/reactivex/internal/operators/completable/CompletableFromRunnable;-><init>(Ljava/lang/Runnable;)V
...
.method public static fromSingle(Lio/reactivex/SingleSource;)Lio/reactivex/Completable;
    ...
    .line 172
    .line 173
    const-string v1, "single is null"
...
.method public static merge(Ljava/lang/Iterable;)Lio/reactivex/Completable;
    ...
    .line 2
    new-instance v1, Lio/reactivex/internal/operators/completable/CompletableMergeIterable;

    invoke-direct {v1, p0}, Lio/reactivex/internal/operators/completable/CompletableMergeIterable;-><init>(Ljava/lang/Iterable;)V
...
.method public static merge(Lorg/reactivestreams/Publisher;)Lio/reactivex/Completable;
    ...
    .line 3
    invoke-static {p0, v1, v0}, Lio/reactivex/Completable;->merge0(Lorg/reactivestreams/Publisher;IZ)Lio/reactivex/Completable;
...
.method public static mergeDelayError(Lorg/reactivestreams/Publisher;)Lio/reactivex/Completable;
    ...
    .line 3
    invoke-static {p0, v1, v2}, Lio/reactivex/Completable;->merge0(Lorg/reactivestreams/Publisher;IZ)Lio/reactivex/Completable;
...
.method public static timer(JLjava/util/concurrent/TimeUnit;)Lio/reactivex/Completable;
    ...
    invoke-static {p0, p1, p2, v1}, Lio/reactivex/Completable;->timer(JLjava/util/concurrent/TimeUnit;Lio/reactivex/Scheduler;)Lio/reactivex/Completable;
...
.method public static unsafeCreate(Lio/reactivex/CompletableSource;)Lio/reactivex/Completable;
    ...
    .line 24
    .line 25
    instance-of v1, p0, Lio/reactivex/Completable;
    ...
    .line 28
    .line 29
    new-instance v1, Lio/reactivex/internal/operators/completable/CompletableFromUnsafeSource;

    .line 30
    .line 31
    invoke-direct {v1, p0}, Lio/reactivex/internal/operators/completable/CompletableFromUnsafeSource;-><init>(Lio/reactivex/CompletableSource;)V
...
.method public static using(Ljava/util/concurrent/Callable;Lio/reactivex/functions/Function;Lio/reactivex/functions/Consumer;Z)Lio/reactivex/Completable;
    ...
    const-string v1, "completableFunction is null"
    ...
    .line 5
    new-instance v1, Lio/reactivex/internal/operators/completable/CompletableUsing;

    invoke-direct {v1, p0, p1, p2, p3}, Lio/reactivex/internal/operators/completable/CompletableUsing;-><init>(Ljava/util/concurrent/Callable;Lio/reactivex/functions/Function;Lio/reactivex/functions/Consumer;Z)V
...
.method public final blockingGet(JLjava/util/concurrent/TimeUnit;)Ljava/lang/Throwable;
    ...
    .line 7
    invoke-virtual {v1, p1, p2, p3}, Lio/reactivex/internal/observers/BlockingMultiObserver;->blockingGetError(JLjava/util/concurrent/TimeUnit;)Ljava/lang/Throwable;
...
.method public final doOnComplete(Lio/reactivex/functions/Action;)Lio/reactivex/Completable;
    ...
    .line 244
    invoke-direct/range {v1 .. v7}, Lio/reactivex/Completable;->doOnLifecycle(Lio/reactivex/functions/Consumer;Lio/reactivex/functions/Consumer;Lio/reactivex/functions/Action;Lio/reactivex/functions/Action;Lio/reactivex/functions/Action;Lio/reactivex/functions/Action;)Lio/reactivex/Completable;
...
.method public final onErrorComplete()Lio/reactivex/Completable;
    ...
    invoke-virtual {p0, v1}, Lio/reactivex/Completable;->onErrorComplete(Lio/reactivex/functions/Predicate;)Lio/reactivex/Completable;
...
.method public final onErrorComplete(Lio/reactivex/functions/Predicate;)Lio/reactivex/Completable;
    ...
    .line 3
    new-instance v1, Lio/reactivex/internal/operators/completable/CompletableOnErrorComplete;

    invoke-direct {v1, p0, p1}, Lio/reactivex/internal/operators/completable/CompletableOnErrorComplete;-><init>(Lio/reactivex/CompletableSource;Lio/reactivex/functions/Predicate;)V
...
.method public final onErrorResumeNext(Lio/reactivex/functions/Function;)Lio/reactivex/Completable;
    ...
    .line 175
    .line 176
    const-string v1, "errorMapper is null"
    ...
    .line 180
    .line 181
    new-instance v1, Lio/reactivex/internal/operators/completable/CompletableResumeNext;

    .line 182
    .line 183
    invoke-direct {v1, p0, p1}, Lio/reactivex/internal/operators/completable/CompletableResumeNext;-><init>(Lio/reactivex/CompletableSource;Lio/reactivex/functions/Function;)V
...
.method public final retry(JLio/reactivex/functions/Predicate;)Lio/reactivex/Completable;
    ...
    invoke-virtual {v1, p1, p2, p3}, Lio/reactivex/Flowable;->retry(JLio/reactivex/functions/Predicate;)Lio/reactivex/Flowable;
...
.method public final startWith(Lio/reactivex/Observable;)Lio/reactivex/Observable;
    ...
    invoke-virtual {p1, v1}, Lio/reactivex/Observable;->concatWith(Lio/reactivex/ObservableSource;)Lio/reactivex/Observable;
...
.method public final toMaybe()Lio/reactivex/Maybe;
    ...
    .line 88
    .line 89
    instance-of v1, p0, Lio/reactivex/internal/fuseable/FuseToMaybe;
    ...
    .line 94
    check-cast v1, Lio/reactivex/internal/fuseable/FuseToMaybe;

    .line 95
    .line 96
    invoke-interface {v1}, Lio/reactivex/internal/fuseable/FuseToMaybe;->fuseToMaybe()Lio/reactivex/Maybe;
    ...
    .line 285
    .line 286
    invoke-direct {v1, p0}, Lio/reactivex/internal/operators/maybe/MaybeFromCompletable;-><init>(Lio/reactivex/CompletableSource;)V
