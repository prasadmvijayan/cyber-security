...
.method public static a(Landroid/util/Size;Landroid/util/Rational;)Landroid/graphics/Rect;
    ...
    .line 106
    invoke-direct {v2, v0, p1, v1, p0}, Landroid/graphics/Rect;-><init>(IIII)V
...
.method public static b(Landroid/graphics/Rect;ILandroid/util/Size;I)Landroid/graphics/Rect;
    ...
    .line 29
    .line 30
    invoke-static {p3, v1, v2, v3}, Landroidx/camera/core/internal/utils/ImageUtil;->k(FFFF)F
    ...
    .line 45
    .line 46
    invoke-static {v1, v2, v3, p1}, Landroidx/camera/core/internal/utils/ImageUtil;->k(FFFF)F
    ...
    .line 67
    .line 68
    invoke-virtual {v0, p1, p3}, Landroid/graphics/Matrix;->mapRect(Landroid/graphics/RectF;Landroid/graphics/RectF;)Z
...
.method private static c([BLandroid/graphics/Rect;I)[B
    ...
    .line 26
    invoke-static {p0, v1, v2, v1}, Landroid/graphics/BitmapRegionDecoder;->newInstance([BIIZ)Landroid/graphics/BitmapRegionDecoder;
...
.method public static j(Landroidx/camera/core/ImageProxy;Landroid/graphics/Rect;I)[B
    .locals 2
    .param p0    # Landroidx/camera/core/ImageProxy;
        .annotation build Landroidx/annotation/NonNull;
        .end annotation
...
.method private static l([BIILandroid/graphics/Rect;I)[B
    ...
    .line 254
    :cond_0
    invoke-virtual {v8, p3, p4, v1}, Landroid/graphics/YuvImage;->compressToJpeg(Landroid/graphics/Rect;ILjava/io/OutputStream;)Z
...
.method public static n(Landroidx/camera/core/ImageProxy;)Z
    .locals 4
    .param p0    # Landroidx/camera/core/ImageProxy;
        .annotation build Landroidx/annotation/NonNull;
        .end annotation
    ...
    .line 232
    invoke-interface {p0}, Landroidx/camera/core/ImageProxy;->Q()Landroid/graphics/Rect;
    ...
    .line 248
    invoke-static {v1, v2, v3, p0}, Landroidx/camera/core/internal/utils/ImageUtil;->m(IIII)Z
...
.method public static p(Landroidx/camera/core/ImageProxy;Landroid/graphics/Rect;I)[B
    .locals 2
    .param p0    # Landroidx/camera/core/ImageProxy;
        .annotation build Landroidx/annotation/NonNull;
        .end annotation
    ...
    .line 45
    .line 46
    invoke-static {p0}, Landroidx/camera/core/internal/utils/ImageUtil;->q(Landroidx/camera/core/ImageProxy;)[B
...
.method public static q(Landroidx/camera/core/ImageProxy;)[B
    .locals 19
    .param p0    # Landroidx/camera/core/ImageProxy;
        .annotation build Landroidx/annotation/NonNull;
        .end annotation
