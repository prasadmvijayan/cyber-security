...
.method public static a(Landroid/graphics/Rect;)Landroid/graphics/Matrix;
    ...
    .line 246
    .line 247
    invoke-static {v1}, Landroidx/camera/core/impl/utils/TransformUtils;->b(Landroid/graphics/RectF;)Landroid/graphics/Matrix;
...
.method public static c(Landroid/graphics/RectF;Landroid/graphics/RectF;I)Landroid/graphics/Matrix;
    ...
    .line 40
    .line 41
    invoke-static {p0, p1, p2, v0}, Landroidx/camera/core/impl/utils/TransformUtils;->d(Landroid/graphics/RectF;Landroid/graphics/RectF;IZ)Landroid/graphics/Matrix;
...
.method public static d(Landroid/graphics/RectF;Landroid/graphics/RectF;IZ)Landroid/graphics/Matrix;
    ...
    .line 54
    :cond_0
    invoke-static {p1}, Landroidx/camera/core/impl/utils/TransformUtils;->b(Landroid/graphics/RectF;)Landroid/graphics/Matrix;
...
.method public static k(Landroid/util/Size;I)Landroid/util/Size;
    ...
    .line 27
    .line 28
    invoke-static {p1}, Landroidx/camera/core/impl/utils/TransformUtils;->q(I)I
    ...
    .line 32
    invoke-static {p1}, Landroidx/camera/core/impl/utils/TransformUtils;->f(I)Z
    ...
    .line 37
    .line 38
    invoke-static {p0}, Landroidx/camera/core/impl/utils/TransformUtils;->j(Landroid/util/Size;)Landroid/util/Size;
...
.method public static l(Landroid/util/Size;)Landroid/graphics/Rect;
    .locals 1
    .param p0    # Landroid/util/Size;
        .annotation build Landroidx/annotation/NonNull;
        .end annotation
    ...
    .line 31
    .line 32
    invoke-static {p0, v0, v0}, Landroidx/camera/core/impl/utils/TransformUtils;->m(Landroid/util/Size;II)Landroid/graphics/Rect;
...
.method public static m(Landroid/util/Size;II)Landroid/graphics/Rect;
    .locals 3
    .param p0    # Landroid/util/Size;
        .annotation build Landroidx/annotation/NonNull;
        .end annotation
    ...
    .line 140
    invoke-direct {v1, p1, p2, v2, p0}, Landroid/graphics/Rect;-><init>(IIII)V
...
.method public static n(Landroid/util/Size;)Landroid/graphics/RectF;
    ...
    .line 2
    invoke-static {p0, v0, v0}, Landroidx/camera/core/impl/utils/TransformUtils;->o(Landroid/util/Size;II)Landroid/graphics/RectF;
...
.method public static o(Landroid/util/Size;II)Landroid/graphics/RectF;
    .locals 4
    .param p0    # Landroid/util/Size;
        .annotation build Landroidx/annotation/NonNull;
        .end annotation
...
.method public static p(Landroid/graphics/Matrix;Landroid/graphics/Rect;)Landroid/graphics/Matrix;
    .locals 1
