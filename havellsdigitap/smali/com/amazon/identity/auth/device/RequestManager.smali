...
.method private cleanupOldActiveRequests()V
    ...
    .line 261
    .line 262
    sget-object v3, Lcom/amazon/identity/auth/device/RequestManager;->LOG_TAG:Ljava/lang/String;
    ...
    .line 268
    .line 269
    const-string v5, "Purging active request "
    ...
    .line 281
    invoke-static {v3, v4}, Lcom/amazon/identity/auth/map/device/utils/MAPLog;->d(Ljava/lang/String;Ljava/lang/String;)I

    .line 282
    .line 283
    .line 284
    iget-object v3, p0, Lcom/amazon/identity/auth/device/RequestManager;->activeRequests:Ljava/util/Map;
    ...
    .line 293
    invoke-virtual {v3, v2}, Lcom/amazon/identity/auth/device/ResponseManager;->removePendingResponse(Ljava/lang/String;)Landroid/net/Uri;
...
.method public static declared-synchronized getInstance()Lcom/amazon/identity/auth/device/RequestManager;
    ...
    .line 148
    .line 149
    sget-object v2, Lcom/amazon/identity/auth/device/RequestManager;->INSTANCE:Lcom/amazon/identity/auth/device/RequestManager;
    ...
    .line 152
    .line 153
    new-instance v2, Lcom/amazon/identity/auth/device/RequestManager;

    .line 154
    .line 155
    invoke-direct {v2}, Lcom/amazon/identity/auth/device/RequestManager;-><init>()V

    .line 156
    .line 157
    .line 158
    sput-object v2, Lcom/amazon/identity/auth/device/RequestManager;->INSTANCE:Lcom/amazon/identity/auth/device/RequestManager;
...
.method public static getRequestIdFromResponseUri(Landroid/net/Uri;)Ljava/lang/String;
    ...
    .line 151
    .line 152
    invoke-direct {v0, p0, v2}, Lcom/amazon/identity/auth/device/AuthError;-><init>(Ljava/lang/String;Lcom/amazon/identity/auth/device/AuthError$ERROR_TYPE;)V
...
.method public executeRequest(Lcom/amazon/identity/auth/device/AbstractRequest;Landroid/content/Context;)V
    ...
    .line 55
    invoke-virtual {v0, p1, v2, p2}, Lcom/amazon/identity/auth/device/ExternalBrowserManager;->openUrl(Lcom/amazon/identity/auth/device/AbstractRequest;Ljava/lang/String;Landroid/content/Context;)V
...
.method public handleResponse(Landroid/net/Uri;Landroid/content/Context;)Z
    ...
    .line 1
    invoke-virtual {p0, p1, p2, v1}, Lcom/amazon/identity/auth/device/RequestManager;->handleResponse(Landroid/net/Uri;Landroid/content/Context;Lcom/amazon/identity/auth/device/api/workflow/RequestContext;)Z
...
.method public handleResponse(Landroid/net/Uri;Landroid/content/Context;Lcom/amazon/identity/auth/device/api/workflow/RequestContext;)Z
    ...
    const-string v4, "Handling response for request "
    ...
    check-cast v3, Lcom/amazon/identity/auth/device/AbstractRequest;
    ...
    .line 5
    invoke-virtual {v3}, Lcom/amazon/identity/auth/device/AbstractRequest;->getOriginalRequest()Lcom/amazon/identity/auth/device/interactive/InteractiveRequest;

    move-result-object v0

    invoke-virtual {v0, p3}, Lcom/amazon/identity/auth/device/interactive/InteractiveRequest;->setRequestContext(Lcom/amazon/identity/auth/device/api/workflow/RequestContext;)V

    .line 6
    :cond_0
    invoke-virtual {v3, p1, p2}, Lcom/amazon/identity/auth/device/AbstractRequest;->handleResponse(Landroid/net/Uri;Landroid/content/Context;)Z
    ...
    invoke-static {v2, p1}, Lcom/amazon/identity/auth/map/device/utils/MAPLog;->d(Ljava/lang/String;Ljava/lang/String;)I

    .line 8
    invoke-virtual {p0, v3, p2}, Lcom/amazon/identity/auth/device/RequestManager;->executeRequest(Lcom/amazon/identity/auth/device/AbstractRequest;Landroid/content/Context;)V
