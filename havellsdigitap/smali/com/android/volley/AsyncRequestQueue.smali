...
# direct methods
.method static synthetic k(Lcom/android/volley/AsyncRequestQueue;)V
    .locals 0

    .line 1
    invoke-direct {p0}, Lcom/android/volley/AsyncRequestQueue;->v()V
...
.method static synthetic l(Lcom/android/volley/AsyncRequestQueue;)Lcom/android/volley/AsyncCache;
    .locals 1
...
.method static synthetic n(Lcom/android/volley/AsyncRequestQueue;Lcom/android/volley/Cache$Entry;Lcom/android/volley/Request;)V
    .locals 1
    ...
    .line 22
    .line 23
    invoke-direct {p0, p1, p2}, Lcom/android/volley/AsyncRequestQueue;->u(Lcom/android/volley/Cache$Entry;Lcom/android/volley/Request;)V
...
.method static synthetic o(Lcom/android/volley/AsyncRequestQueue;)Lcom/android/volley/WaitingRequestManager;
    .locals 1
...
.method static synthetic p(Lcom/android/volley/AsyncRequestQueue;)Ljava/util/concurrent/ExecutorService;
    .locals 0
...
.method static synthetic q(Lcom/android/volley/AsyncRequestQueue;)Lcom/android/volley/AsyncNetwork;
    .locals 1
...
.method static synthetic r(Lcom/android/volley/AsyncRequestQueue;Lcom/android/volley/Request;Lcom/android/volley/Response;Z)V
    .locals 1
    ...
    .line 100
    .line 101
    invoke-direct {p0, p1, p2, p3}, Lcom/android/volley/AsyncRequestQueue;->s(Lcom/android/volley/Request;Lcom/android/volley/Response;Z)V
...
.method private s(Lcom/android/volley/Request;Lcom/android/volley/Response;Z)V
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .line 10
    .line 11
    invoke-virtual {p0}, Lcom/android/volley/RequestQueue;->e()Lcom/android/volley/ResponseDelivery;
    ...
    .line 15
    invoke-interface {p3, p1, p2}, Lcom/android/volley/ResponseDelivery;->a(Lcom/android/volley/Request;Lcom/android/volley/Response;)V
...
.method private static t()Ljava/util/concurrent/PriorityBlockingQueue;
    .locals 4
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "()",
    ...
    .line 282
    .line 283
    new-instance v2, Lcom/android/volley/AsyncRequestQueue$3;

    .line 284
    .line 285
    invoke-direct {v2}, Lcom/android/volley/AsyncRequestQueue$3;-><init>()V
...
.method private u(Lcom/android/volley/Cache$Entry;Lcom/android/volley/Request;)V
    .locals 9
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .line 16
    .line 17
    invoke-virtual {p0, p2}, Lcom/android/volley/AsyncRequestQueue;->h(Lcom/android/volley/Request;)V
    ...
    .line 190
    invoke-virtual {p1, v5, v6}, Lcom/android/volley/Cache$Entry;->b(J)Z
    ...
    .line 315
    :cond_3
    iget-object v7, p0, Lcom/android/volley/AsyncRequestQueue;->p:Ljava/util/concurrent/ExecutorService;

    .line 316
    .line 317
    new-instance v8, Lcom/android/volley/AsyncRequestQueue$CacheParseTask;
...
.method private v()V
    ...
    .line 6
    .line 7
    iget-object v3, p0, Lcom/android/volley/AsyncRequestQueue;->s:Ljava/util/List;
    ...
    .line 18
    iput-boolean v3, p0, Lcom/android/volley/AsyncRequestQueue;->t:Z
    ...
    .line 36
    .line 37
    invoke-virtual {p0, v2}, Lcom/android/volley/AsyncRequestQueue;->b(Lcom/android/volley/Request;)V
...
.method b(Lcom/android/volley/Request;)V
    ...
    .line 215
    .line 216
    iget-object v1, p0, Lcom/android/volley/AsyncRequestQueue;->u:Ljava/lang/Object;
    ...
    .line 219
    :try_start_0
    iget-boolean v2, p0, Lcom/android/volley/AsyncRequestQueue;->t:Z
    ...
    .line 306
    .line 307
    iget-object v1, p0, Lcom/android/volley/AsyncRequestQueue;->l:Lcom/android/volley/AsyncCache;
    ...
    .line 312
    .line 313
    new-instance v2, Lcom/android/volley/AsyncRequestQueue$CacheTask;

    .line 314
    .line 315
    invoke-direct {v2, p0, p1}, Lcom/android/volley/AsyncRequestQueue$CacheTask;-><init>(Lcom/android/volley/AsyncRequestQueue;Lcom/android/volley/Request;)V
    ...
    .line 333
    :cond_3
    invoke-virtual {p0, p1}, Lcom/android/volley/AsyncRequestQueue;->h(Lcom/android/volley/Request;)V
...
.method public i()V
    ...
    .line 1
    invoke-virtual {p0}, Lcom/android/volley/AsyncRequestQueue;->j()V
    ...
    .line 5
    .line 6
    invoke-static {}, Lcom/android/volley/AsyncRequestQueue;->t()Ljava/util/concurrent/PriorityBlockingQueue;
    ...
    .line 10
    invoke-virtual {v0, v1}, Lcom/android/volley/AsyncRequestQueue$ExecutorFactory;->b(Ljava/util/concurrent/BlockingQueue;)Ljava/util/concurrent/ExecutorService;
    ...
    .line 22
    invoke-virtual {v0, v1}, Lcom/android/volley/AsyncRequestQueue$ExecutorFactory;->a(Ljava/util/concurrent/BlockingQueue;)Ljava/util/concurrent/ExecutorService;
    ...
    .line 29
    .line 30
    invoke-virtual {v0}, Lcom/android/volley/AsyncRequestQueue$ExecutorFactory;->c()Ljava/util/concurrent/ScheduledExecutorService;
    ...
    .line 39
    .line 40
    invoke-virtual {v0, v1}, Lcom/android/volley/AsyncNetwork;->d(Ljava/util/concurrent/ExecutorService;)V
    ...
    .line 46
    .line 47
    invoke-virtual {v0, v1}, Lcom/android/volley/AsyncNetwork;->e(Ljava/util/concurrent/ExecutorService;)V
    ...
    .line 53
    .line 54
    invoke-virtual {v0, v1}, Lcom/android/volley/AsyncNetwork;->f(Ljava/util/concurrent/ScheduledExecutorService;)V
...
.method public j()V
    ...
    .line 147
    .line 148
    iput-object v2, p0, Lcom/android/volley/AsyncRequestQueue;->n:Ljava/util/concurrent/ExecutorService;
    ...
    .line 156
    .line 157
    iput-object v2, p0, Lcom/android/volley/AsyncRequestQueue;->p:Ljava/util/concurrent/ExecutorService;
    ...
    .line 165
    .line 166
    iput-object v2, p0, Lcom/android/volley/AsyncRequestQueue;->o:Ljava/util/concurrent/ScheduledExecutorService;
