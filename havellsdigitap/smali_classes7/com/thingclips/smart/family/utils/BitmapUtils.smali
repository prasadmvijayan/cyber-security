.class public final Lcom/thingclips/smart/family/utils/BitmapUtils;
...
.method public static a(Landroid/content/Context;Landroid/graphics/Bitmap;FF)Landroid/graphics/Bitmap;
    ...
    .line 10
    .line 11
    invoke-static {p0, p1, p2, p3, v0}, Lcom/thingclips/smart/family/utils/BitmapUtils;->b(Landroid/content/Context;Landroid/graphics/Bitmap;FFZ)Landroid/graphics/Bitmap;
...
.method public static b(Landroid/content/Context;Landroid/graphics/Bitmap;FFZ)Landroid/graphics/Bitmap;
    .locals 10
    .param p2    # F
        .annotation build Landroidx/annotation/FloatRange;
        .end annotation
    ...
    .line 142
    .line 143
    invoke-static {p1}, Lcom/thingclips/smart/family/utils/BitmapUtils;->d(Landroid/graphics/Bitmap;)Z
    ...
    .line 210
    .line 211
    invoke-static {p0, v3, p3, p4}, Lcom/thingclips/smart/family/utils/BitmapUtils;->e(Landroid/content/Context;Landroid/graphics/Bitmap;FZ)Landroid/graphics/Bitmap;
    ...
    .line 234
    invoke-static {p0, v1, v2, p2}, Landroid/graphics/Bitmap;->createScaledBitmap(Landroid/graphics/Bitmap;IIZ)Landroid/graphics/Bitmap;
...
.method public static e(Landroid/content/Context;Landroid/graphics/Bitmap;FZ)Landroid/graphics/Bitmap;
    .locals 3
    .param p2    # F
        .annotation build Landroidx/annotation/FloatRange;
        .end annotation
...
.method public static f(Landroid/app/Activity;)Landroid/graphics/Bitmap;
    .locals 7
    ...
    .line 67
    invoke-static {p0}, Lcom/thingclips/smart/utils/CommonUtil;->i(Landroid/content/Context;)I
    ...
    .line 71
    invoke-static {p0}, Lcom/thingclips/smart/family/utils/BitmapUtils;->c(Landroid/content/Context;)[F
    ...
    .line 86
    :try_start_0
    invoke-static {v4, v0, v5, v6, p0}, Landroid/graphics/Bitmap;->createBitmap(Landroid/graphics/Bitmap;IIII)Landroid/graphics/Bitmap;
    ...
    .line 96
    .line 97
    const-string v3, "Error occurred while create screen shot :"
